...
public class CustomerListAdapter extends BaseAdapter {
    ...
    public CustomerListAdapter(List<CustomerListModel> listModels, Context context, ArrayList<CustomerListModel> arrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        CustomerListAdapter.ViewHolder viewHolder = null;
        ...
        titleSelected = view.findViewById(R.id.title_check);
